...
let favoriteFoods = ["chicken", "strawberries", "ice cream", "potatoes"];
...
console.log("List of animals:", animalArray);
...
let dessert = "lava cake";
favoriteFoods.push(dessert);
console.log("Added dessert to favorite foods,", favoriteFoods);
